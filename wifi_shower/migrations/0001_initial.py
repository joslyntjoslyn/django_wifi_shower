# Generated by Django 2.1.3 on 2018-11-07 22:24
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gallons_saved', models.FloatField(blank=True, null=True)),
                ...
                ('average_shower_time', models.FloatField(blank=True, null=True)),
                ('aggregate_shower_savings', models.FloatField(blank=True, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('shower_cycle', models.FloatField(blank=True, null=True)),
                ('shower_temp', models.FloatField(blank=True, null=True)),
                ('gallons_used', models.FloatField(blank=True, null=True)),
                ('gallons_saved', models.FloatField(blank=True, null=True)),
                ('average_shower_time', models.FloatField(blank=True, null=True)),
                ('aggregate_shower_savings', models.FloatField(blank=True, null=True)),
                ('average_shower_savings', models.FloatField(blank=True, null=True)),
                ('challenge_level', models.FloatField(blank=True, null=True)),
                ('challenge_time', models.FloatField(blank=True, null=True)),
